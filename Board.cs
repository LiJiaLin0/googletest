...
namespace 象棋
{
    ...
    class Board
    {
        ...
        public static Point Point_To_Virtual(Point p) {
        ...
        public static Point Margin_To_Virtual(Thickness margin) { 
        ...
        public static void move(int x1,int y1,int x2,int y2, int[,] map){
        map[x2,y2]=map[x1,y1];
        map[x1,y1]=-1;
      }
